...
import { Swords, CheckCircle, Hourglass, X, Clock, Calendar } from 'lucide-react';
...
export const ChallengeItem: React.FC<ChallengeItemProps> = ({ challenge, onPlayClick }) => {
    ...
    const handlePlayClick = async (e: React.MouseEvent) => {
        ...
        console.log('[ChallengeItem] difficulty:', difficulty);
        
        // Build the URL
        const gameUrl = `/game/${challenge.puzzle_type}?challenge_id=${challenge.id}&difficulty=${difficulty}`;
        console.log('[ChallengeItem] Navigating to:', gameUrl);
        
        // Call onPlayClick if it exists
        if (onPlayClick) {
            try {
                await onPlayClick();
                console.log('[ChallengeItem] onPlayClick completed');
            } catch (error) {
        ...
        navigate(gameUrl);
        console.log('[ChallengeItem] Navigation triggered');

                ...
                <div className="relative">
                    <div className="flex items-center h-[4rem] px-4">
                        ...
                        <nav className="absolute left-0 right-0 flex justify-center items-center space-x-6">
                            <a href="/#" className="bg-primary font-medium text-md text-white px-4 py-2 rounded-md shadow-[0_5px_0_0_#033778] active:shadow-[0_4px_0_0_rgba(0,0,0,0.15)] translate-y-[-2px] active:translate-y-0" type="button">
                                Home
                            </a>

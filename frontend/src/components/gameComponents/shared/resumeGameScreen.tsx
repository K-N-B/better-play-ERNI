...
export const ResumeGameScreen = ({
    ...
    return (
        ...
        <div className="flex items-center justify-center min-h-[500px] p-8">
            ...
            <div className={`bg-white rounded-2xl shadow-xl max-w-md w-full p-8 text-center border-2 ${colors.border} ${colors.bg}`}>
                ...
                <p className="text-xl text-black mb-8 leading-relaxed">
                    {guessCount > 0 ? (
                        <>
                            You've made <strong className={colors.primary}>{guessCount}</strong> of{' '}
                            <strong>{maxGuesses}</strong> guesses on <strong className="text-black">{difficulty}</strong> difficulty. Keep it up!
                        </>
                    ) : (
                        <>

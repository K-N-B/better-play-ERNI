  ...
  return (
    <header className="sticky top-0 left-0 w-full bg-slate-50 shadow-md z-50 py-2">
      <div className="mx-auto w-full max-w-7xl rounded-lg transition-colors">
        <div className="flex items-center justify-between h-12 md:h-16 px-6 py-6">
          {/* Left: Logo */}
          ...
          <div className="flex items-center gap-4">
            <Link
              ...
              className={clsx(
                ...
                // Active styles
                isShopActive &&
                  `active:translate-y-0.5 active:shadow-[0_3px_0_0] ${shopNavStyle.activeClasses}`,
                // Inactive styles
            ...
            {!authLoading && user && (
              <Tippy
                content="These are the points you currently have!"
                placement="bottom"
              >
                ...
                return (
                  <Link
                    ...
                    className={clsx(
                      ...
                      isActive &&
                        `active:translate-y-0.5 active:shadow-[0_3px_0_0] ${item.activeClasses}`,
              ...
              return (
                <Link
                  ...
                  className={clsx(
                    ...
                    // Active styles
                    isActive &&
                      `active:translate-y-0.5 active:shadow-[0_3px_0_0] ${linkItem.style.activeClasses}`,
                    // Inactive styles

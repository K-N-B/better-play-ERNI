    ...
    return (
        <div className="mb-6 w-full">
            ...
            <div className="flex justify-between text-xs mt-1 text-gray-500 font-medium">
                ...
                <span
                    className={`${isPenalty
                            ? (bonusOrPenaltyValue > 0 ? "text-red-600" : "text-gray-400") // Penalty Style
                            : (bonusOrPenaltyValue > 0 ? "text-yellow-700" : "text-gray-400")        // Bonus Style
                        }`}
                >
                    {bonusOrPenaltyLabel}: {isPenalty ? "-" : "+"}{bonusOrPenaltyValue}
                </span>
            </div>
        </div>
    );

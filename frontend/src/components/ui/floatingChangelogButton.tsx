...
export const FloatingChangelogButton = () => {
    ...
    return (
        <>
            {/* Floating button */}
            <button
                className="fixed bottom-6 right-6 z-50 bg-primary-600 text-white p-4 rounded-full shadow-lg hover:bg-primary-500 active:bg-primary-700 transition-all flex items-center justify-center hover:scale-110"
                            ...
                            <div className="prose prose-sm prose-blue max-w-none text-gray-600">
                                <ReactMarkdown
                                    components={{
                                        ...
                                        h3: ({children}) => <h3 className="text-md font-bold text-primary-600 mt-4 mb-2">{children}</h3>,

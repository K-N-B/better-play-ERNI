...
export const MOCK_ONLINE_USERS: OnlineUser[] = [
  ...
  { id: 3, username: "jerome_B", profile_picture_url: null }, // Example user
...
export const MOCK_ACTIVITY_HUB: ActivityHubResponse = {
  recent_activity: [
    {
      id: 105,
      user: { id: 2, username: "Dayniel Caadiang", profile_picture_url: null },
      puzzle_name: "Sudoku",
      difficulty: "easy",
    ...
    {
      id: 104,
      user: { id: 1, username: "gavin_cii", profile_picture_url: null },
      puzzle_name: "Wordle",
      difficulty: "hard",
    ...
    {
      id: 103,
      user: { id: 3, username: "jerome_B", profile_picture_url: null },
  ...
  online_users: [
    { id: 1, username: "gavin_cii", profile_picture_url: null },
    { id: 3, username: "jerome_B", profile_picture_url: null },
    { id: 2, username: "Dayniel Caadiang", profile_picture_url: null },
  ],
};

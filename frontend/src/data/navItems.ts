...
export const shopNavStyle = {
  ...
  path: '/shop',
  activeClasses:
    'bg-yellow-500 text-white shadow-[0_5px_0_0] shadow-yellow-800', // Example colors
...
export const navItems: NavItem[] = [
  {
    ...
    activeClasses:
      'bg-primary text-slate-50 shadow-[0_5px_0_0] shadow-primary-900',
  ...
  { name: '┃' },
  {
    ...
    path: '/game/sudoku',
    activeClasses:
      'bg-pink-400 text-slate-50 shadow-[0_5px_0_0] shadow-pink-800',

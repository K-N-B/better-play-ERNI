...
from .views import (
    ...
    GetProgressView,
    GetHintView,
    CheckSubmissionView,         # ✅ NEW
    GetTodaySubmissionsView,     # ✅ NEW
)
...
urlpatterns = [
    ...
    # Example: GET /api/gameplay/progress/1/wordlepuzzle/42/
    path(
    ...
    # Get a Sudoku hint
    # Example: POST /api/gameplay/hint/1/sudokupuzzle/42/
    path(
    ...
    # Example: GET /api/gameplay/check-submission/2025-11-02/wordlepuzzle/42/
    path(

...
class PuzzleAttemptSerializer(serializers.ModelSerializer):
    class Meta:
        model = PuzzleAttempt
        fields = ['id', 'user', 'puzzle_type', 'puzzle_id', 'progress_data', 
                  'time_spent_ms', 'completed', 'created_at', 'updated_at']
...
class SubmissionSerializer(serializers.ModelSerializer):
    class Meta:
        model = Submission
        fields = ['id', 'user', 'puzzle_type', 'puzzle_id', 'puzzle_date',
                  'difficulty', 'points_awarded', 'time_taken_ms', 'tries',

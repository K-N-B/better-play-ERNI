    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "time_taken_ms",
                    models.BigIntegerField(help_text="Time in milliseconds"),
                ),
                (
                    "tries",
                    models.PositiveIntegerField(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="gameplay_su_content_cec32f_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="submission",
            index=models.Index(
                fields=["created_at", "difficulty"],
                name="gameplay_su_created_8c9cf2_idx",
            ),
        ),
    ]

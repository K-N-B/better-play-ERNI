...
from .views import DailyPuzzlesView, GetSudokuHintLimitsView, GameScoreLimitsView
from . import views
...
urlpatterns = [
    ...
    path("limits/<str:puzzle_type>/", GameScoreLimitsView.as_view(), name="game-score-limits"),
]

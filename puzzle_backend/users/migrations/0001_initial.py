    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_admin', models.BooleanField(default=False, help_text='Designates whether the user can access custom website admin features.')),
                ('last_active', models.DateTimeField(default=django.utils.timezone.now)),
                ('azure_id', models.CharField(blank=True, help_text='Azure Active Directory Object ID', max_length=255, null=True, unique=True)),
                ('total_points_alltime', models.BigIntegerField(default=0)),

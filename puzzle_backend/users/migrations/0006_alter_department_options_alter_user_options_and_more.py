# Generated by Django 5.2.7 on 2025-11-25 09:07
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='user',
            name='challenges_made_count',
            field=models.PositiveIntegerField(default=0, help_text='Total number of challenges sent to others'),
        ),
        migrations.AlterField(
            model_name='user',
            name='current_points',
            field=models.BigIntegerField(db_index=True, default=0, help_text='Spendable points (can be used in shop)'),
        ),
        migrations.AlterField(
            model_name='user',
            name='current_streak_count',
            field=models.PositiveIntegerField(default=0, help_text='Number of consecutive days with activity'),
        ),
        migrations.AlterField(
            model_name='user',
            name='department',
        ...
        migrations.AlterField(
            model_name='user',
            name='is_admin',
            field=models.BooleanField(default=False, help_text='Legacy admin flag (deprecated - use role field instead)'),
        ),
        migrations.AlterField(
            model_name='user',
            name='last_active',
            field=models.DateTimeField(blank=True, help_text='Last date user completed a puzzle (for streak tracking)', null=True),
        ),
        migrations.AlterField(
            model_name='user',
            name='max_streak_count',
        ...
        migrations.AlterField(
            ...
            field=models.URLField(blank=True, help_text="URL to the user's profile picture (from Azure AD or cloud storage)", max_length=500, null=True),
        ),
        migrations.AlterField(
            model_name='user',
            name='total_points_alltime',
            field=models.BigIntegerField(db_index=True, default=0, help_text='Total points earned across all time (read-only)'),
        ),
        migrations.AddIndex(
            model_name='user',
            index=models.Index(fields=['azure_id'], name='users_user_azure_i_a5852e_idx'),
        ),
        migrations.AddIndex(
            model_name='user',
        ...
        migrations.AddIndex(
            model_name='user',
            index=models.Index(fields=['-total_points_alltime'], name='users_user_total_p_4c8f46_idx'),
        ),
        migrations.AddIndex(
            model_name='user',
            index=models.Index(fields=['-current_points'], name='users_user_current_684e9b_idx'),
        ),
    ]

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, help_text='Image for the reward (optional)', null=True, upload_to='rewards/')),
                ...
                ('max_claims_per_user', models.PositiveIntegerField(blank=True, help_text='Max times a user can claim this. Null means infinite.', null=True)),
            ],
            options={
                'ordering': ['cost', 'name'],
            },
